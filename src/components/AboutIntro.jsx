  ...
  return (
    <section className="about-intro section-padding">
      <div className="container">
        <div className="row">
          {/* Sol: Yazılar */}
          <div className="col-lg-7 text-block">
            <h2>
              At <span className="highlight">River Star Construction</span>, we
              bring years of hands-on experience to every stage of construction
              — from the ground up to the final finish.
            </h2>
            <p className="text">
              Our expertise includes masonry, formwork, and exterior finishing
              systems. With a reliable, skilled crew, we take full
              responsibility for the entire structure — not just one part.
            </p>
            <p className="text emphasize">
              What we promise is what we deliver:{" "}
              <span className="bold">clean</span>,{" "}
              <span className="bold">complete</span>, and{" "}
              <span className="bold">always on time.</span>
            </p>
          </div>

          {/* Sağ: Gökdelenler + yeni vinç */}
